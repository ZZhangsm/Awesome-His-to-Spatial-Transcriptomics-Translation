...
| ---- | ------------------------------------------------------------------------------------------------------------------------- | ------------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026 | **Histopathology-centered computational evolution of spatial omics: integration, mapping, and foundation models** |  Brief. Bioinform.  | Survey | [link](https://doi.org/10.1093/bib/bbag387)          
| 2026 | **Benchmarking the translational potential of spatial gene expression prediction from histology**                         | Nat. Commun.  | Benchmark | [link](https://www.nature.com/articles/s41467-025-56618-y)                                                                                                             |
...
| 2026 | **Path2ST: Hierarchical Cell-Tissue Grounded Cross-Modal Translation for Spatial Transcriptomics** | arxiv | Path2ST | [link](https://arxiv.org/abs/2608.14710) | [link](https://github.com/RuochenLiu23/Path2ST) |
| 2026 | **VOICE: A Vision-Omics Foundation Model Integrating Direct and Retrieval-Based Prediction of In-situ Single-Cell Gene Expression** | arxiv | VOICE | [link](https://arxiv.org/abs/2608.08366) | - |
| 2026 | **The Multimodal Pretraining Framework CarHE Predicts Spatial Transcriptomics in Tumors from Routine Pathology Images** | Cancer Research | CarHE | [link](https://doi.org/10.1158/0008-5472.CAN-26-1480) | [link](https://github.com/Jwzouchenlab/CarHE)                  |
| 2026 | **Towards unified molecule-enhanced pathology image representation learning via integrating spatial transcriptomics** |   Pattern Recognition | UMPIRE | [link](https://www.sciencedirect.com/science/article/pii/S0031320325011215) |  [link](https://github.com/Hanminghao/Umpire) |
| 2026 | **DriftST: One-Step Generative Inference of Spatial Transcriptomics from H&E Histology** |   arxiv | DriftST | [link](https://arxiv.org/abs/2607.04740) |  [link](https://github.com/yyh030806/DriftST) |
| 2026 | **PSSD: Progressive Spatial-Semantic Decoupling for Flow-Based Gene Expression Prediction from Histology Images** |   Bioinformatics | PSSD | [link](https://doi.org/10.1093/bioinformatics/btag598) |  [link](https://github.com/ChyaZhang/PSSD) |
| 2026 | **Mixture-of-Residuals Meets LLM-Semantic Gene Conditioning: Interpretable Spatial Transcriptomic Prediction from H&E Image** |   KDD | MiraST | [link](https://dl.acm.org/doi/abs/10.1145/3770855.3819011) |  [link](https://github.com/ZhangLabGT/MiraST) |
| 2026 | **Asymmetric dual pathway fusion for histology driven spatial transcriptomic prediction** |   Scientific reports | AsymST | [link](https://www.nature.com/articles/s41598-026-63426-x) |  [link](https://github.com/181sxl/AsymST) |
| 2026 | **Gene Ontology-Guided Hierarchical Spatial Gene Expression Prediction from Histopathology Images** |  ACM MM 2026 | MSGR | [link](https://arxiv.org/pdf/2608.00405) |  [link](https://github.com/NozomiMizore/MSGR) |
| 2026 | **HistoGPA: A Context-Conditioned Gene-Prior Attention Framework for Histology-Based Spatial Gene Expression Prediction** | arxiv | HistoGPA      | [link](https://arxiv.org/abs/2607.24364) | - |
...
| 2026 | **GenAR: Next-Scale Autoregressive Generation for Spatial Gene Expression Prediction**                                                                  | Medical Image Analysis              | GenAR         | [link](https://doi.org/10.1016/j.media.2026.104232) | [link](https://github.com/oyjr/genar)                          |
...
| 2026 | **FLAG: Foundation model representation with Latent diffusion Alignment via Graph for spatial gene expression prediction**                                          | ICML                                 | FLAG       | [link](https://arxiv.org/abs/2605.18055)                                                                                                                                            | [link](https://github.com/darkflash03/FLAG/)                 |
...
| 2025 | **Multi-modal topology-embedded graph learning for spatially resolved genes prediction from pathology images with prior gene similarity information** | CVPR | M2TGLGO         | [link](https://ieeexplore.ieee.org/abstract/document/11091830) | - |
...
| 2024 | **Transcriptomics-guided slide representation learning in computational pathology** | CVPR | TANGLE     | [link](https://ieeexplore.ieee.org/abstract/document/10656058) | [link](https://github.com/mahmoodlab/TANGLE) |
...
| Year | Title                                                                                                                                          | Venue                 | Method        | Paper                                                                                       | Code                                                                     |
| ---- | ---------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- | ------------- | ------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| 2026 | **Multimodal alignment improves generalizability of genomic biomarker prediction in computational pathology**                | Cell Reports Methods | MARBLE          | [link](https://doi.org/10.1016/j.crmeth.2026.101578) | [link](https://github.com/microsoft/MARBLE)                            |
...
| 2026 | **Ultrarapid deep 3D histology enables intraoperative mapping of glioma infiltration**                | Cell | ULTRA          | [link](https://www.cell.com/cell/fulltext/S0092-8674(26)00824-X) | [link](https://github.com/Zhijie-Liu/Ultrarapid-Deep-3D-Histology)
